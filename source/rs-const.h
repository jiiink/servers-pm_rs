...
#define RUPDATE_IS_VM_UPDATING()            (((rupdate.flags & RS_UPDATING) != 0) && (rupdate.vm_rpupd))
#define RUPDATE_IS_VM_INIT_DONE()           ((rproc_ptr[_ENDPOINT_P(VM_PROC_NR)]->r_flags & RS_INIT_DONE) != 0)
#define RUPDATE_IS_RS_UPDATING()            (((rupdate.flags & RS_UPDATING) != 0) && (rupdate.rs_rpupd))
