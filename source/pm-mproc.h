#ifndef MPROC_TABLE_H
#define MPROC_TABLE_H
...
#define MP_MAGIC	0x0C0FFEE0

#if defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)
_Static_assert(NR_PROCS > 0, "NR_PROCS must be positive");
_Static_assert(_NSIG > 0, "_NSIG must be positive");
_Static_assert(NGROUPS_MAX > 0, "NGROUPS_MAX must be positive");
_Static_assert(NR_ITIMERS > 0, "NR_ITIMERS must be positive");
_Static_assert(PROC_NAME_LEN > 0, "PROC_NAME_LEN must be positive");
#endif
