...
const char *get_next_label(const char *ptr, char *label, const char *caller_label);
...
const char* srv_to_string_gen(const struct rproc *rp, int is_verbose);
const char* srv_upd_to_string(const struct rprocupd *rpupd);
